...
export default function ThankYou() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && (window as any).customElements?.get('lottie-player')) {
      loadLottie();
    } else {
    ...
    <section style={{
      ...
      <h1 style={{
        ...
        <span style={{ color: '#e65c00' }}>
          Selamat Bundda, pembayaran berhasil!
        </span><br />
        Bundda bisa akses worksheet-nya melalui link di bawah ini.
      </h1>
      ...
      <p style={{
        ...
        Program 3 hari untuk si kecil sudah siap Bundda akses.
      </p>
      ...
      <p style={{
        ...
        Bundda bisa mengakses worksheet-nya melalui link di bawah ini.
      </p>
      ...
      <div style={{
        ...
        <p style={{
          ...
          <strong>Silakan cek email Bundda sekarang.</strong> Tenang Bun, Bundda bisa akses worksheet ini kapan saja karena sudah dikirim melalui email. Setelah dibuka, Bundda bisa langsung download dan belajar bersama si kecil hari ini.
        </p>
      </div>
    </section>
  );
