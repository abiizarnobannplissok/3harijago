            ...
            <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
                ...
                <div style={{ textAlign: 'left', marginBottom: '24px' }}>
                    <p style={{ color: '#64748b', fontSize: '14px', lineHeight: 1.8, marginBottom: '12px' }}>
                        <strong style={{ color: '#1a0800' }}>Bunda Mira (32), Yogyakarta</strong>, punya anak 6 tahun yang super aktif dan geologic terdistraksi. Waktu ikut les, biayanya terasa berat—tapi hasilnya nggak sebanding karena anaknya nggak enjoy dan jadi makin males belajar.
                    </p>
                    <p style={{ color: '#64748b', fontSize: '14px', lineHeight: 1.8, marginBottom: '16px' }}>
                        Akhirnya Bunda Mira coba Worksheet "3 Hari Jago Inggris" di rumah. Yang bikin kaget, anaknya malah mulai bilang: <strong style={{ color: '#1a0800' }}>"Bunda, belajar yang itu lagi!"</strong> Soalnya aktivitasnya bukan hafalan yang bikin tegang, tapi gambar warna-warni, mewarnai, word search, dan matching game—jadi anak merasa kayak main.
                    </p>

                    <p style={{ color: '#e65c00', fontSize: '14px', fontWeight: 700, margin: '0 0 10px' }}>Yang Bunda Mira suka:</p>

                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '16px' }}>
                        {[
                            'Aktivitasnya memang anak suka: mewarnai, cari kata, cocokkan gambar',
                            'Bunda nggak perlu jago Inggris—tinggal ikuti panduannya',
                    ...
                    <p style={{ color: '#e65c00', fontSize: '14px', fontWeight: 700, margin: '0 0 10px' }}>Kesimpulan Bunda Mira:</p>
                    <p style={{ color: '#64748b', fontSize: '14px', fontStyle: 'italic', lineHeight: 1.7, borderLeft: '3px solid #ff8c00', paddingLeft: '14px', margin: 0 }}>
                        "Anak tuh bukan butuh les mahal. Yang dia butuh itu cara belajar yang seru—dan waktu sebentar tapi rutin bareng Bundanya."
                    </p>
                </div>
